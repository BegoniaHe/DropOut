...
1. 打开下载的 `.dmg` 文件。
2. 将 DropOut 拖到“应用程序”文件夹。
3. 如果看到安全警告，前往“系统设置 → 隐私与安全性”并允许该应用。

> 如果 macOS 提示“应用已损坏”或“无法打开”，这有时并不代表文件真的损坏，也可能是权限或隔离属性（quarantine）导致。
> 你可以在终端尝试：
>
> ```bash
> sudo xattr -cr /Applications/DropOut.app
> ```
>
> 然后重新打开应用。
